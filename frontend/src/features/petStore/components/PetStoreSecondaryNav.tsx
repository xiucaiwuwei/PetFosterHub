            ...
            <div className="hidden md:flex items-center ml-4">
              ...
              <Link to="/cart" className="ml-3">
                <motion.button
                  whileHover={buttonVariants.hover}
                  whileTap={buttonVariants.tap}
                  className="bg-white hover:bg-gray-50 text-orange-600 border border-orange-300 rounded-lg p-2 transition-all duration-300 shadow-sm hover:shadow relative"
                >
                  <i className="fa-solid fa-shopping-cart text-base"></i>
                  <span className="absolute -top-0.5 -right-0.5 bg-orange-500 text-white text-xs w-4 h-4 flex items-center justify-center rounded-full">0</span>
                </motion.button>
              </Link>
              {/* 订单记录图标 */}
              <Link to="/profile/orders" className="ml-3">
                <motion.button
                  whileHover={buttonVariants.hover}
                  whileTap={buttonVariants.tap}
                  className="bg-white hover:bg-gray-50 text-orange-600 border border-orange-300 rounded-lg p-2 transition-all duration-300 shadow-sm hover:shadow"
                >
