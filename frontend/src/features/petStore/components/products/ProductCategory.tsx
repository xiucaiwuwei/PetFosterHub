        ...
        <div className="p-5">
          ...
          <div className="mb-6">
            ...
            {showPriceRange && (
              ...
              >
                {/* 在小屏幕上使用垂直布局 */}
                <div className={`${isMobile ? 'flex flex-col gap-3' : 'flex items-center space-x-3'} mb-4`}>
                  ...
                  {!isMobile && <span className="text-gray-400 font-medium">至</span>}
                  {isMobile && <span className="text-gray-400 font-medium text-center">至</span>}
                  <div className="relative flex-1 min-w-[100px]">
                    <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">¥</span>
                    <input
                      type="number"
